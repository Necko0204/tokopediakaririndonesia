...
export default function BalanceCard({ balance, persistence, onTopUp, onWithdraw }: BalanceCardProps) {
  return (
    <div className="rounded bg-white p-5 text-ink shadow-panel">
      ...
      <p className="mt-1 text-xs font-semibold uppercase text-slate-400">Saving to {persistence}</p>
