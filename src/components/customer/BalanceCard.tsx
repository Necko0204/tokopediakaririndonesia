  ...
  return (
    <div className="rounded-3xl bg-white/95 p-5 text-ink shadow-[0_18px_50px_rgba(15,23,42,0.16)] ring-1 ring-white/70 backdrop-blur">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-sm font-semibold text-slate-500">Member balance</p>
        ...
        <span className="rounded-full bg-emerald-50 px-3 py-1 text-[11px] font-black uppercase text-forest">Active</span>
      </div>
