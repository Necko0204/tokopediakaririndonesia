import { Boxes, ClipboardList, LayoutDashboard, ShieldCheck, Users, WalletCards } from "lucide-react";
import type { TransactionStatus } from "./types";

export const adminTabs = ["Overview", "Members", "Orders", "Finance", "Catalog", "Account"] as const;
